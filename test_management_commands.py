...
class ManagementCommandTester:
    ...
    def test_help_command(self) -> bool:
        ...
        exit_code, stdout, stderr = self.run_command(["bash", str(self.script_path), "--help"])
    ...
    def test_version_command(self) -> bool:
        ...
        exit_code, stdout, stderr = self.run_command(["bash", str(self.script_path), "version"])
    ...
    def test_check_updates_command(self) -> bool:
        ...
        exit_code, stdout, stderr = self.run_command(["bash", str(self.script_path), "check-updates"], timeout=60)
        ...
        found_phrases = sum(1 for phrase in expected_phrases if phrase.lower() in stdout.lower())
    ...
    def test_rollback_command(self) -> bool:
        ...
        exit_code, stdout, stderr = self.run_command(["bash", str(self.script_path), "rollback"])
        ...
        found_terms = sum(1 for term in expected_terms if term.lower() in stdout.lower())
        ...
        for test_name, test_func in tests:
            ...
            try:
                if test_func():
                    ...
                    self.test_results.append((test_name, "FAIL", "Test function returned False"))
            except Exception as e:
