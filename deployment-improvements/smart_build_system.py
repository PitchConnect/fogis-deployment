...
class SmartBuildSystem:
    ...
    def _should_ignore_file(self, file_path: Path) -> bool:
        ...
        ignore_patterns = [
            ".git", "__pycache__", "*.pyc", "*.log", ".DS_Store",
            "node_modules", ".coverage", "htmlcov", ".pytest_cache"
        ]
    ...
    def build_service(self, service_name: str, context_path: Path, 
                     dockerfile_path: Path, force_rebuild: bool = False) -> str:
    ...
    def build_all_services(self, services_config: Dict[str, Dict]) -> Dict[str, str]:
        ...
        for service_name in sorted_services:
            ...
            try:
                image_tag = self.build_service(service_name, context_path, dockerfile_path)
    ...
    def _sort_services_by_dependencies(self, services_config: Dict[str, Dict]) -> List[str]:
    ...
    def cleanup_old_images(self, keep_count: int = 3) -> None:
        ...
        logger.info(f"Cleaning up old images, keeping {keep_count} most recent per service")
            ...
            for image_info in images[keep_count:]:
                ...
                if exit_code == 0:
                    ...
                    cache_keys_to_remove = [
                        k for k, v in self.build_cache.items() 
