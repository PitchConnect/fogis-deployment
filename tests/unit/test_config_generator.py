...
from config_generator import ConfigGenerationError, ConfigGenerator
...
class TestConfigGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_config = {
            "metadata": {"version": "2.0", "created": "2025-01-12T10:00:00Z"},
            "fogis": {
                "username": "test_user",
                "password": "test_pass",
            ...
            "google": {
                ...
                "drive": {"folder_base": "WhatsApp_Group_Assets"},
            },
            "services": {
                "ports": {
                    "api_client": 9086,
