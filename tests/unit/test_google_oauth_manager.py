...
class TestGoogleOAuthManager:
    ...
    def test_load_existing_token_expired_with_refresh(self, mock_request, mock_from_file, mock_exists):
    ...
    def test_get_credentials_with_oauth_flow(self):
        ...
        with patch.object(self.manager, 'load_existing_token', return_value=False), \
             patch.object(self.manager, 'validate_credentials_file', return_value=True), \
             patch.object(self.manager, 'perform_oauth_flow', return_value=True):
    ...
    def test_test_credentials_success(self, mock_build):
        ...
        mock_build.side_effect = [mock_calendar_service, mock_drive_service, mock_people_service]
