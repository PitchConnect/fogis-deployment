...
class TestConfigValidator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valid_config = {
            ...
            "system": {"docker": {"restart_policy": "unless-stopped"}},
        }
    ...
    def test_validate_missing_sections(self):
        ...
        incomplete_config = {"fogis": {"username": "test_user"}}
    ...
    def test_validate_google_oauth_missing_section(self):
        ...
        self.assertTrue(
            any("Missing Google OAuth configuration" in error for error in errors)
        )
    ...
    def test_validate_google_oauth_missing_scopes(self):
        ...
        config_missing_scopes["google"]["oauth"]["scopes"] = [
            "https://www.googleapis.com/auth/calendar"
        ]
        ...
        self.assertTrue(
            any("Missing recommended OAuth scope" in warning for warning in warnings)
        )

    def test_check_port_conflicts(self):
        """Test port conflict detection"""
        config_port_conflict = self.valid_config.copy()
        config_port_conflict["services"]["ports"][
            "match_processor"
        ] = 9086  # Same as api_client
    ...
    def test_validate_service_configuration(self):
        ...
        config_invalid_cron["services"]["processing"][
        ...
        self.assertTrue(
            any("Invalid cron schedule format" in warning for warning in warnings)
        )
