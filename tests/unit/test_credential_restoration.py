...
"""
    ...
    def test_env_file_update(self, temp_dir, mock_env_file):
        ...
        new_content = original_content.replace(
            "FOGIS_USERNAME=old_user", "FOGIS_USERNAME=Test User"
        ).replace("FOGIS_PASSWORD=old_password", "FOGIS_PASSWORD=test_password")
...
"""
    ...
    def test_env_file_loading_missing_file(self, temp_dir):
        ...
        validator = FOGISCredentialValidator()
        success = validator.load_credentials_from_env_file(
