...
"""
    ...
    def test_get_nested_value(self):
        ...
        self.assertEqual(
            config_manager._get_nested_value(config_manager.config, 'services.ports.api_client'),
            9086
        )
    ...
    def test_convert_env_value(self):
        ...
        self.assertEqual(config_manager._convert_env_value('test_string'), 'test_string')
