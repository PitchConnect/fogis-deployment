...
class TestBackupManager:
    ...
    def test_backup_content_verification(self):
        ...
        assert os.path.exists(
            f"{backup_content_dir}/credentials/google-credentials.json"
        )
    ...
    def test_list_backups_empty(self):
        ...
        assert (
            ...
            or "No backups found" in result.stdout
        )
    ...
    def test_cleanup_old_backups_no_old_backups(self):
        ...
        assert result.returncode == 0
        assert (
            "No old backups to clean" in result.stdout
            or "No backup directory found" in result.stdout
        )
