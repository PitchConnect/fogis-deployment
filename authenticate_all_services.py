...
def check_credentials():
    ...
    if not os.path.exists("credentials.json"):
        ...
        print(
            "📋 Please download Google OAuth credentials and save as 'credentials.json'"
        )
        return False
    return True
...
def check_services_running():
    ...
    services = ["fogis-calendar-phonebook-sync", "google-drive-service"]
    ...
    try:
        ...
        subprocess.run(
            [
                ...
                "cp",
                "token.json",
                "fogis-calendar-phonebook-sync:/app/token.json",
            ],
            check=True,
        )
        ...
        subprocess.run(
            ["docker", "restart", "fogis-calendar-phonebook-sync"], check=True
        )
