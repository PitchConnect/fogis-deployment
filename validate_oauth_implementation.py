...
def test_enhanced_oauth_wizard():
    ...
    checks.append(check_file_exists(
        "lib/enhanced_oauth_wizard.py",
        "Enhanced OAuth wizard file"
    ))
    
    checks.append(check_file_exists(
        "docs/OAUTH_SETUP_CHECKLIST.md",
        "OAuth setup checklist"
    ))
    
    checks.append(check_file_exists(
        "test_enhanced_oauth_wizard.py",
        "OAuth wizard test script"
    ))
    ...
    if os.path.exists(prereq_file):
        checks.append(check_file_contains(
            prereq_file,
            "Enhanced Setup",
            "Enhanced setup section in prerequisites"
        ))
